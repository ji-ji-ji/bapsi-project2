                           ...
                           <div class="col-md-9" data-for="email">
                            ...
                            <div class="col-md-5" data-for="hintq">
								...
								<div class="col-md-5" data-for="email">
									<input type="text" class="form-control input"
										data-form-field="Email" placeholder="비밀번호힌트대답" id="hinta"
										readonly="readonly" style="text-align: center; font-size: 17px;">
								</div>
								<div class="col-md-7" data-for="email">
									<input type="text" class="form-control input" name="hinta"
										data-form-field="Email" placeholder="비밀번호 힌트를 입력해주세요" id="hinta"
										value="${member.hinta}">
								</div>

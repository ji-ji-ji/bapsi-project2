...
<form:form method="post" commandName="recipeVO" name="wForm" onsubmit="return doWrite()">
                        ...
                        <div class="form-group">
                            <label>레시피 정보</label>
							<!-- summernote -->
							<form:textarea path="content" id="summernote" name="content" />
							<form:errors path="content" />
<!-- Modal -->
<!-- 
<a data-toggle="modal" href="testForm" data-target="#modal-testNew" role="button" data-backdrop="static" id="popbutton">
